...
const Nav = () => {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed top-3 left-0  h-auto w-auto  mb-3 transform transition-transform duration-300 ${
          menuOpen ? "translate-x-0" : "-translate-x-full"
        } sm:translate-x-0`}
      >
        {/* Navigation Menu */}
        <div className=" rounded-lg p-6 ml-3  bg-black border-2 border-slate-800 text-gray-200  ">
          {/* Close Button */}
