...
const Nav = () => {
  ...
  return (
    <div>
      ...
      {/* Navigation Menu */}
      <div
        className={`fixed top-10 left-0 ml-3 p-6 mt-3 h-auto rounded-lg mb-3 w-auto bg-black border-2 border-slate-800 text-gray-200  transform transition-transform duration-300 ${
